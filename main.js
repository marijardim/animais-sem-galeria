...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFuncionamento)\n/* harmony export */ });\nfunction initFuncionamento() {\n  var funcionamento = document.querySelector('[data-semana]');\n  var datas = funcionamento.dataset.semana.split(', ').map(Number); //ARRAY DIAS\n\n  var horarios = funcionamento.dataset.horario.split(', ').map(Number); //ARRAY HORARIOS\n\n  var dataAgora = new Date();\n  var diaDaSemana = dataAgora.getDay(); //HOJE\n\n  var horaAgora = dataAgora.getHours(); //AGORA\n\n  var semanaAberto = datas.includes(diaDaSemana); //? funcionamento.classList.add('aberto') : funcionamento.classList.remove('aberto')\n\n  var horarioAberto = horaAgora >= horarios[0] && horaAgora < horarios[1];\n\n  if (semanaAberto && horarioAberto) {\n    funcionamento.classList.add('aberto');\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/funcionamento.js?");
